...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Human skin detection: three different\\[-0.2cm]
    methods using correlation rules based\\
...
And, last but not least, I would like to be grateful to Inatel and Qualcomm, the companies I have worked for during the years of the realization of this work. They were extremely supportive of me in all the difficult moments I faced through the course of this project.
...
\noindent FARIA, R. A. D. \textbf{Detecção de pele humana: três métodos diferentes usando regras de correlação baseadas em agrupamento dinâmico de cores}.
...
% Abstract
\chapter*{Abstract}
\noindent FARIA, R. A. D. \textbf{Human skin detection: three different methods using correlation rules based on dynamic color clustering}.
