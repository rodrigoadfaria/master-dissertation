...
quantidade de luz branca aplicada a matiz. Combinadas, matiz e saturação são
conhecidas como cromaticidade e, portanto, uma cor deve ser caracterizada por
seu brilho e cromaticidade \citep{gonzalez:02}.
...
é representada por um único ponto \citep{gonzalez:02}.
