...
\end{tabular}
\end{small}
\caption{Definition of addition, subtraction, multiplication and division arithmetic operations in two $f_1$ and $f_2$ images.}
...
\end{tabular}
\end{small}
\caption{Definition of AND, OR, XOR and NOT logic operations in two $f_1$ and $f_2$ images.}
