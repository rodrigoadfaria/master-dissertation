...
As seções \ref{sec:clasificadores_svm} tratam de alguns dos classificadores aplicados nos experimentos preliminares deste trabalho.


%% ------------------------------------------------------------------------- %%
\subsection{Máquinas de Vetores Suporte}
As Máquinas de Vetores Suporte (SVM)
